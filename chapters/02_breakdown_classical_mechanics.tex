...
\section{The fall of determinism}
  ...
  In the case where the gun shoots macroscopic bullets we imagine the distance gun-screen to be large, implying that the bullets might arrive at different locations due to error, vibrations, wind, etc.
  Therefore, we expect bullets to arrive as a beam.
   ...
   \end{figure}
     ...
     Since the source is very far, waves will reach the wall will be plane waves.
...
$$ia \frac{\partial {}}{\partial {t}}\psi=-b \frac{\partial {^2}}{\partial {x^2}}\psi(x,t)$$
  ...
  Uncertainty is reflected by the fact that we do not talk about a space trajectory, the interpretation is stochastic as the wave function is a probability.
